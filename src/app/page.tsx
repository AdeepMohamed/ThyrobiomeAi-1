  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 selection:bg-teal-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/80 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3">
            <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-teal-600 to-indigo-600 text-white shadow-md shrink-0">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link href="/register">
              <Button variant="gradient" size="sm" className="text-xs font-semibold px-2.5 sm:px-3">
                Create Account
              </Button>
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden pt-8 pb-14 sm:pt-20 sm:pb-28">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-6 sm:space-y-8">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-teal-200 bg-teal-50 px-3 sm:px-3.5 py-1 sm:py-1.5 text-[11px] sm:text-xs font-semibold text-teal-800 dark:border-teal-900/60 dark:bg-teal-950/50 dark:text-teal-300 max-w-[95%]">
            <Sparkles className="h-3.5 w-3.5 text-teal-600 shrink-0" />
            <span className="truncate">Powered by Grok 3 AI & Deterministic Safety Guardrails</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link href="/login" className="w-full sm:w-auto">
              <Button size="lg" variant="gradient" className="w-full text-sm sm:text-base h-11 sm:h-12 px-6 sm:px-8 font-semibold shadow-lg">
                Enter Patient Dashboard
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link href="/login" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full text-sm sm:text-base h-11 sm:h-12 px-6 border-slate-300 dark:border-slate-800">
      ...
      <section className="py-10 sm:py-16 bg-white border-y border-slate-200/80 dark:bg-slate-900 dark:border-slate-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <h2 className="text-xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 sm:gap-6">
            <Card className="shadow-xs border-slate-200 dark:border-slate-800">
              <CardContent className="p-5 sm:p-6 space-y-3">
                <div className="rounded-xl bg-teal-50 p-2.5 sm:p-3 text-teal-600 w-fit dark:bg-teal-950 dark:text-teal-300">
            ...
            <Card className="shadow-xs border-slate-200 dark:border-slate-800">
              <CardContent className="p-5 sm:p-6 space-y-3">
                <div className="rounded-xl bg-sky-50 p-2.5 sm:p-3 text-sky-600 w-fit dark:bg-sky-950 dark:text-sky-300">
            ...
            <Card className="shadow-xs border-slate-200 dark:border-slate-800">
              <CardContent className="p-5 sm:p-6 space-y-3">
                <div className="rounded-xl bg-rose-50 p-2.5 sm:p-3 text-rose-600 w-fit dark:bg-rose-950 dark:text-rose-300">
            ...
            <Card className="shadow-xs border-slate-200 dark:border-slate-800">
              <CardContent className="p-5 sm:p-6 space-y-3">
                <div className="rounded-xl bg-indigo-50 p-2.5 sm:p-3 text-indigo-600 w-fit dark:bg-indigo-950 dark:text-indigo-300">
      ...
      <section className="py-10 sm:py-16 bg-slate-50 dark:bg-slate-950">
        <div className="mx-auto max-w-4xl px-4 text-center space-y-5 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-left max-w-xl mx-auto">
            <Link href="/login" className="rounded-2xl border border-teal-200 bg-white p-4 sm:p-5 shadow-xs hover:border-teal-500 transition-all dark:border-slate-800 dark:bg-slate-900">
              <div className="flex items-center gap-2 text-teal-700 dark:text-teal-300 font-bold mb-1 text-sm">
            ...
            <Link href="/login" className="rounded-2xl border border-rose-200 bg-white p-4 sm:p-5 shadow-xs hover:border-rose-500 transition-all dark:border-slate-800 dark:bg-slate-900">
              <div className="flex items-center gap-2 text-rose-700 dark:text-rose-300 font-bold mb-1 text-sm">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 bg-white py-6 sm:py-8 dark:border-slate-800 dark:bg-slate-900 text-xs text-slate-500">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-center sm:text-left">
